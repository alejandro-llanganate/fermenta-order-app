...
export default function OrdersManagement({ onBack }: OrdersManagementProps) {
    ...
    const calculateTotalWithShipping = () => {
        return calculateSubtotal() + (applyShippingSurcharge ? shippingSurcharge : 0);
    };
        ...
        const orderSummary = `
            <div class="text-left">
                <div class="mb-4">
                    ...
                    ${applyShippingSurcharge ? `<p><strong>Recargo de envío:</strong> $${shippingSurcharge.toFixed(2)}</p>` : ''}
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div>
                                            <div className="flex items-center mb-3">
                                                <input
                                                    type="checkbox"
                                                    id="applyShippingSurcharge"
                                                    checked={applyShippingSurcharge}
                                                    onChange={(e) => setApplyShippingSurcharge(e.target.checked)}
                                                    className="h-4 w-4 text-orange-600 focus:ring-orange-500 border-gray-300 rounded"
                                                />
                                                <label htmlFor="applyShippingSurcharge" className="ml-2 text-sm font-medium text-gray-700">
                                                    Aplica cargo adicional de envío
                                                </label>
                                            </div>
